...
public class Door_script : MonoBehaviour
{
    ...
    public GameObject rotate_prefabs;
    ...
    public bool open_the_door () 
    {
        ...
        if (n_step == 0)
        {
            ...
            if (rotate_prefabs.transform.rotation.y == -90)
            {
        ...
        if (n_step < counter)
        {
            ...
            targetRotation_step = Quaternion.Euler(rotate_prefabs.transform.rotation.x, rotate_prefabs.transform.rotation.y + doorAngleStep, rotate_prefabs.transform.rotation.z);
